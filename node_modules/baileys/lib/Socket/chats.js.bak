...
export const makeChatsSocket = (config) => {
    ...
    /** atualize o status do seu perfil */
    ...
    const resyncAppState = ev.createBufferedFunction(async (collections, isInitialSync) => {
        // usamos isso para determinar quais eventos disparar
        // caso contrário, quando ressincronizarmos do zero, todas as notificações serão disparadas
