...
export const makeSocket = (config) => {
    ...
    if (printQRInTerminal) {
        console.warn('⚠️ A opção printQRInTerminal foi descontinuada. Você não receberá mais códigos QR no terminal automaticamente. Por favor, ouça o evento connection.update e processe o QR como preferir.');
    }
